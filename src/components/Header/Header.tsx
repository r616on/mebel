        ...
        <Carousel
          ...
          <div>
            <CaroselItem
              ...
              body={
                'Мы создаем комбинированную мебель из разных материалов, таких, как металл, дерево, ЛДСП, ЛМДФ, искусственный камень, стекло и, в принципе, любой вид материала, который существует в природе.'
              }
            />
          </div>
          <div>
          ...
          <div className="container">
            {!visible && (
              <motion.ul
                ...
                <li style={{ display: 'flex', justifyContent: 'flex-end', flexWrap: 'wrap' }}>
                  <Button type="link" style={{ color: 'white' }} icon={<PhoneOutlined />} href="tel:+79114916400">
                    8 911 491 - 64 - 00
                  </Button>
                  <Button type="link" style={{ color: 'white' }} icon={<PhoneOutlined />} href="tel:+74012926400">
                    8 (4012) 926 - 400
                  </Button>
                </li>
                <li>
